...
public class centeralignment extends SequentialCommandGroup {
;
  /** Creates a new autoalignment. */
  public centeralignment(CommandSwerveDrivetrain drivebase,Elevator elevatorsubsystem,double vertical ,double horizontal) {
