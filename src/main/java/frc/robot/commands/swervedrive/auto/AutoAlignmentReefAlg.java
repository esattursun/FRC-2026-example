...
public class AutoAlignmentReefAlg extends Command {
  ...
  public 
    AutoAlignmentReefAlg(CommandSwerveDrivetrain drivebase,double vertical ,double horizontal) {
  ...
  public AutoAlignmentReefAlg(CommandSwerveDrivetrain drivebase,double vertical ,double horizontal,Station station) {
    this.drivebase = drivebase; 
    this.vertical = vertical;
    this.horizontal = horizontal;
  ...
  public void initialize() {
    ...
    if(station != null){
      ...
      drivebase.gettrueCoralStationPose(station,vertical,horizontal);
       ...
       targetPose =  drivebase.gettrueCoralStationPosex(vertical,horizontal);
    }    
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber("dist", Math.abs(drivebase.gettrueCoralStationPosex(vertical,horizontal).getTranslation().getDistance(drivebase.getPose().getTranslation())));
