...
;
  ...
  public autoalignment(CommandSwerveDrivetrain drivebase,Elevator elevatorsubsystem,double vertical ,double horizontal) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new AutoAlignmentReef(drivebase, vertical, horizontal),
        // new AimatCoralStation(drivebase).withTimeout(0.6),
        new AutoAlignmentReefWithPid(drivebase, vertical, horizontal),
        ...
        Commands.run(()-> drivebase.brake(), drivebase).withTimeout(0.2),
  ...
  public autoalignment(CommandSwerveDrivetrain drivebase,double vertical ,double horizontal,Station station) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
