...
public class AutoAlignmentReefWithPidAlg extends Command {
  ...
  AutoAlignmentReefWithPidAlg(CommandSwerveDrivetrain drivebase,double vertical ,double horizontal) {
  ...
  public AutoAlignmentReefWithPidAlg(CommandSwerveDrivetrain drivebase,double vertical ,double horizontal,Station station) {
    this.drivebase = drivebase; 
    this.vertical = vertical;
    this.horizontal = horizontal;
